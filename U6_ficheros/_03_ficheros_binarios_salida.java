...
public class _03_ficheros_binarios_salida { // salida = escribir = write
  public static void main(String[] args) {
    ...
    // Sin embargo, esta vez vamos dar una manera diferente de hacerlo, que nos permite un
    ...
    // Para imprimir objetos típicos de Java (Integer, Double, String, etc) no hay problema, no hay
    // que hacer nada especial. Pero... ¿y para imprimir un objeto de una clase que hemos
