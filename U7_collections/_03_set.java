...
public class _03_set {
  public static void main(String[] args) {
    ...
    */
    ...
    // Al añadir mediante add un elemento que ya está añadido, no da error,
    // simplemente devuelve false

    // Diferentes implementaciones:
    // HashSet: no garantiza ningún orden en la inserción
    // TreeSet: garantiza el orden natural de los elementos o el que
    //          se le pase mediante comparator
    // LinkedHashSet: garantiza el orden basado en la inserción,
    //                ya que siempre inserta al final
    ...
    // 2. Si el criterio de ordenación va a ser el natural, construimos
    // un TreeSet pasando como argumento al constructor el conjunto que
    // queremos ordenar
    Set<Integer> s3 = new TreeSet<>(s1);
    System.out.println(s3);

    // Podemos filtrar elementos repetidos de una lista convirtiéndolo
    // a Set (además lo ordena, si es un TreeSet, claro)
